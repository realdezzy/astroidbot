...
const envSchema = z.object({
  ...
  TELEGRAM_MINI_APP_URL: z.preprocess((val) => (val === "" ? undefined : val), z.string().url().optional()),
  TELEGRAM_ADMIN_IDS: z.string().default(""),
  TELEGRAM_TOPICS_ENABLED: z.enum(["true", "false", "1", "0"])
    .transform((v) => v === "true" || v === "1").default("false"),
