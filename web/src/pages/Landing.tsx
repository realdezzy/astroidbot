...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 selection:bg-brand-500/30 overflow-x-hidden font-sans">
      ...
      {/* Header / Navigation */}
      <header className="sticky top-0 z-50 backdrop-blur-md bg-gray-950/80 border-b border-gray-900">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-bold text-white text-lg tracking-tight">AstroidBot</span>
              <span className="text-xs block text-gray-500 -mt-1 font-mono">AI TRADING</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <>
                <Link
                  to="/login"
                  className="text-sm font-medium text-gray-400 hover:text-white transition-colors px-2 py-1"
                >
                  Sign In
                </Link>
                <Link
      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-20 pb-28 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <a
            href="#features"
            className="px-8 py-4 bg-gray-900/60 hover:bg-gray-900 border border-gray-800 hover:border-gray-700 text-gray-300 font-medium rounded-xl text-base transition-all duration-200"
          >
            Explore Features
          </a>
        </div>
        ...
        <div className="mt-20 relative max-w-5xl mx-auto rounded-2xl border border-gray-800 bg-gray-900/40 p-4 backdrop-blur-sm shadow-2xl">
          ...
          {/* Top panel bar */}
          <div className="flex items-center justify-between pb-3 border-b border-gray-800 mb-4 px-2">
            <div className="flex items-center gap-1.5">
              <span className="w-3 h-3 rounded-full bg-red-500/80" />
              <span className="w-3 h-3 rounded-full bg-yellow-500/80" />
              <span className="w-3 h-3 rounded-full bg-green-500/80" />
              <span className="text-xs text-gray-500 ml-2 font-mono">astroidbot-dashboard-v1.0.exe</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-xs font-mono px-2 py-0.5 rounded bg-brand-500/20 text-brand-400 border border-brand-500/20">
                STX: $1.85
              </span>
              <span className="text-xs text-gray-500 font-mono">Connected: SP1P...4R8S</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-left">
            {/* Sidebar Simulation */}
            <div className="hidden md:block col-span-1 border-r border-gray-800/80 pr-4 space-y-2">
              <div className="flex items-center gap-2.5 px-3 py-2 bg-brand-500/15 text-brand-400 rounded-lg text-xs font-semibold">
                <Activity className="w-4 h-4" />
                <span>Dashboard</span>
              </div>
              <div className="flex items-center gap-2.5 px-3 py-2 text-gray-500 hover:text-gray-300 rounded-lg text-xs font-medium cursor-pointer transition-colors">
            ...
            <div className="col-span-1 md:col-span-3 space-y-4">
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-gray-950/80 border border-gray-800/80 rounded-xl p-3">
                  <div className="text-[10px] text-gray-500 uppercase font-semibold">Portfolio Value</div>
                  <div className="text-lg font-bold text-white mt-0.5">$18,452.20</div>
                  <div className="text-[10px] text-emerald-400 mt-1 flex items-center gap-0.5">
                    <span>↑ 14.2%</span> <span className="text-gray-600">this week</span>
                  </div>
                </div>
                <div className="bg-gray-950/80 border border-gray-800/80 rounded-xl p-3">
                  <div className="text-[10px] text-gray-500 uppercase font-semibold">Bot Status</div>
                  <div className="text-lg font-bold text-emerald-400 mt-0.5 flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-ping" />
                    <span>ACTIVE</span>
                  </div>
                  <div className="text-[10px] text-gray-500 mt-1">Grid mode enabled</div>
                </div>
                <div className="bg-gray-950/80 border border-gray-800/80 rounded-xl p-3">
                  <div className="text-[10px] text-gray-500 uppercase font-semibold">Total Profit</div>
                  <div className="text-lg font-bold text-white mt-0.5">+$3,412.80</div>
                  <div className="text-[10px] text-gray-500 mt-1">45 trades executed</div>
                </div>
              </div>

              {/* Graphic Chart Simulation */}
              <div className="bg-gray-950/80 border border-gray-800/80 rounded-xl p-4 relative overflow-hidden h-44">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-xs font-semibold text-gray-400">Yield Progression (30d)</span>
      ...
      {/* Features Section */}
      <section id="features" className="max-w-7xl mx-auto px-6 py-24 border-t border-gray-900">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">Why automate with AstroidBot?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-900/40 border border-gray-800 p-8 rounded-2xl hover:border-brand-500/30 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">AI-Driven Parameter Optimization</h3>
          ...
          <div className="bg-gray-900/40 border border-gray-800 p-8 rounded-2xl hover:border-brand-500/30 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Automated Limit Order Engines</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <div className="bg-gray-900/40 border border-gray-800 p-8 rounded-2xl hover:border-brand-500/30 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Secure Non-Custodial Architecture</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
      ...
      <section id="calculator" className="max-w-7xl mx-auto px-6 py-24 border-t border-gray-900">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white">Project your profits</h2>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-gray-400 font-medium">Investment Amount (STX)</span>
              ...
              <div>
                <label className="block text-sm text-gray-400 font-medium mb-3">Trading Strategy</label>
                <div className="grid grid-cols-3 gap-3">
                  {(["conservative", "moderate", "aggressive"] as const).map((strat) => (
                    <button
                      key={strat}
                      onClick={() => setStrategy(strat)}
                      className={`py-2 px-4 rounded-xl text-xs font-bold border capitalize transition-all duration-200 ${strategy === strat
              ...
              {/* Duration selector */}
              <div>
                <label className="block text-sm text-gray-400 font-medium mb-3">Duration</label>
                <div className="grid grid-cols-3 gap-3">
                  {([30, 90, 365] as const).map((d) => (
                    <button
                      key={d}
                      onClick={() => setDays(d)}
                      className={`py-2 px-4 rounded-xl text-xs font-bold border transition-all duration-200 ${days === d
                        ? "bg-brand-500/20 border-brand-500 text-brand-400"
                        : "bg-gray-900/60 border-gray-800 text-gray-400 hover:text-gray-200 hover:border-gray-700"
                        }`}
                    >
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 backdrop-blur-sm relative overflow-hidden">
            <div className="absolute top-0 right-0 w-24 h-24 bg-brand-500/10 rounded-full filter blur-2xl pointer-events-none" />

            <div className="space-y-6">
              <div>
                <span className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Estimated Profit</span>
              ...
              <div className="grid grid-cols-2 gap-4 py-4 border-y border-gray-800/80">
                <div>
                  <span className="text-xs text-gray-500 block">Projected Total</span>
                  <span className="text-lg font-bold text-white mt-0.5 font-mono">{projectedTotal.toFixed(2)} STX</span>
                </div>
                <div>
                  <span className="text-xs text-gray-500 block">Yield APY</span>
                  <span className="text-lg font-bold text-brand-400 mt-0.5 font-mono">{(apy * 100).toFixed(0)}%</span>
                </div>
              </div>

              {/* Dynamic graph drawing */}
              <div className="relative h-44 bg-gray-950/80 border border-gray-800/60 rounded-xl p-4 overflow-hidden">
                <div className="absolute top-2 left-3 text-[10px] text-gray-500 font-mono">PROJECTED COMPOUND CURVE</div>
      ...
      <section id="integrations" className="max-w-7xl mx-auto px-6 py-16 border-t border-gray-900 text-center">
        <span className="text-xs uppercase text-gray-500 tracking-wider font-semibold">Integrations & Protocols</span>
        <div className="mt-8 flex flex-wrap justify-center items-center gap-12 opacity-65 grayscale hover:grayscale-0 transition-all duration-300">
          <div className="flex items-center gap-2">
            <span className="font-bold text-lg text-white font-mono">STACKS</span>
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-brand-500/20 text-brand-400">Layer 2</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-bold text-lg text-white font-mono">ALEX SDK</span>
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-purple-500/20 text-purple-400">DeFi</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-bold text-lg text-white font-mono">VELUMX</span>
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-blue-500/20 text-blue-400">Bridge</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-bold text-lg text-white font-mono">VELAR</span>
      ...
      {/* Contact Section */}
      <section id="contact" className="max-w-4xl mx-auto px-6 py-24 border-t border-gray-900">
        <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8 md:p-12 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-500/5 rounded-full filter blur-3xl pointer-events-none" />

          <div className="text-center max-w-xl mx-auto mb-10">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white">Have questions? Let's connect</h2>
            ...
            <form onSubmit={handleContactSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-gray-950 border border-gray-800 rounded-xl text-sm text-white placeholder-gray-600 focus:border-brand-500 focus:outline-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-gray-950 border border-gray-800 rounded-xl text-sm text-white placeholder-gray-600 focus:border-brand-500 focus:outline-none resize-none"
                  placeholder="How can we help you?"
                />
              </div>
              <button
                type="submit"
                className="w-full py-3 bg-brand-500 hover:bg-brand-600 text-white rounded-xl font-bold text-sm transition-colors flex items-center justify-center gap-2"
              >
                Send Message
      ...
      <footer className="bg-gray-950 border-t border-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-bold text-white text-sm">AstroidBot</span>
              <span className="text-[10px] block text-gray-500 font-mono -mt-1">© 2026. All rights reserved.</span>
            </div>
          </div>
