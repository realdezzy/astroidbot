    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:max-w-lg">
        <div className="glass-card px-4 py-3">
          <p className="text-[10px] uppercase tracking-wide text-muted-text font-bold">
            24H Volume · shown
          </p>
          ...
          <button
            ...
            className={classNames(
              ...
              category === id
                ...
                : "glass-card text-muted-text hover:text-title-text"
            )}
          >
          ...
          <tbody>
            {isLoading && tokens.length === 0 ? (
              ...
              tokens.map((token, index) => (
                ...
                >
                  <td className="px-3 py-2.5 text-xs text-muted-text font-mono">#{index + 1}</td>
                  ...
                  <td className="px-3 py-2.5">
                    <div className="min-w-0">
                      ...
                      <div className="mt-0.5 flex items-center gap-1.5">
                        ...
                        <span className="text-[10px] uppercase font-bold text-muted-text/80">
                  ...
                  <td className="px-3 py-2.5 text-right font-mono tabular-nums text-title-text font-semibold">
                  ...
                  <td className="px-3 py-2.5 text-right font-mono text-xs tabular-nums">
                    {token.txns24h.buys === null && token.txns24h.sells === null ? (
                      ...
                      <span>
                        <span className="text-emerald-400 font-semibold">{count(token.txns24h.buys)}</span>
                        <span className="text-muted-text/50"> / </span>
                        <span className="text-red-400 font-semibold">{count(token.txns24h.sells)}</span>
                      </span>
                    )}
                  </td>
                  ...
                  <td className="px-3 py-2.5 text-right">
                    <Link
                      ...
                      className="rounded-lg bg-brand-500 hover:bg-brand-600 px-3 py-1.5 text-xs font-bold text-white transition-colors inline-block"
                    >
                      Trade
                    </Link>
                  </td>
      ...
      <p className="mt-2 text-xs text-muted-text">
        {data?.total ?? 0} tokens indexed across supported chains.
      </p>
    </div>
  );
}
